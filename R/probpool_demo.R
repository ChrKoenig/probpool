...
save(interaction_matrix, file = "data/Ranunculaceae_interactions.RData")
...
test_probpool = probpool(env_pool = suit.rst.stack,
                          ...
                          interaction_matrix = interaction.matrix, interaction_method = 1)
...
test_probpool = prob.pool(env_pool = suit.rst.stack,
                          disp_pool = disp.rst.stack,
                          occurrences = occ.rst.stack,
