...
disp.rst.stack <- disp_pool(occurrence.surfaces = Simu_specslist.stack)
plot(disp.rst.stack[[3]])
...
plot(occurrence.surfaces[[5]])
plot(disp.rst.stack[[5]])
plot(bio.rst.stack[[5]])
  
plot(disp.rst.stack[[5]]*bio.rst.stack[[5]])


plot(occurrence.surfaces[[3]])
plot(disp.rst.stack[[3]])
plot(bio.rst.stack[[3]])

plot(disp.rst.stack[[3]]*bio.rst.stack[[3]])
